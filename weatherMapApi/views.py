...
def getData(request):
    ...
    # Verify if boyd has location in correct format in POST request
    if 'location' in request_data:
        ...
        # If 'city' is not provided in the request data, return a bad request response
    ...
    if response.status_code == 200:
        ...
        # weather description: clouds, rain, and others. More info: https://openweathermap.org/weather-conditions  
        ...
        mapped_data = {
            'weather': weather,
            'temp': temp,
            'background_color': calcBackgroundColor(json_response['weather'][0]['main'], json_response['main']['temp'])
            }
